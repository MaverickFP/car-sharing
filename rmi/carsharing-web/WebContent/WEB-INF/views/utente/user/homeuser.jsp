...
<head>
<title>CarSharing - Home User</title>
...
<div id="container">
  <div id="navarea">
    <ul id="nav">
      ...
      <li><c:url value="/utente/user/prenota" var="prenota" /> <a href="#">Prenota</a></li>      
  ...
  <div id="lftcol">
    ...
    <div class="leftcolbox">
      ...
      <p> <c:url value="goUserHome" var="somevar" /><a href="${somevar}">Home</a><br />
        <c:url value="/utente/user/prenota" var="prenota" /> <a href="#">Prenota Auto</a><br />
		<c:url value="/utente/user/storico" var="storico" /> <a href="#">Storico Prenotazioni</a><br />
		<c:url value="/utente/user/costi" var="costi" /> <a href="#">Costo Totale</a><br />
  ...
  <div id="maincol">
    ...
    <p>Home page dell'applicazione Car-Sharing</p>
